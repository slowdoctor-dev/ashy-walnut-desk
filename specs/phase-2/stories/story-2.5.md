...
- [ ] AC2: `Action.execute` is rejected if approval is newer than 5 seconds (direct action bypass blocked). — Verify: `mix test test/ashy_walnut_desk/interaction/countdown_guard_test.exs`
