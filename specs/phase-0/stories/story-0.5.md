...
- [ ] AC5: AshPaperTrail-on-User opt-in decision recorded in this story's "Notes during implementation" — either opted in here, or deferred to Phase 1 with a one-line rationale referencing AshAuthentication compatibility. Verify: read the "Notes during implementation" section after execution.
